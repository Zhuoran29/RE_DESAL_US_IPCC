...
def fs_NF_LSRRO_crys(capacity, # m3/day
                     solute_dict,
                     tds):  # mg/L
    m = ConcreteModel()
    m.db = Database()
    ...
    capacities = [feed_vol, nf_cap, lsrro_cap, cryst_cap, lsrro_rr ]
    ...
    lsrro, results = run_lsrro_case(
        ...
        Qin=1e-3*1000,  # inlet feed flowrate m3/s
    ...
    return m, lsrro, cryst, data_table, overall_performance, capacities
...
if __name__ == "__main__":
    ...
    m, lsrro, cryst, data_table, overall_performance, capacities = fs_NF_LSRRO_crys(capacity,
                                                                        solute_dict,
                                                                        tds)
