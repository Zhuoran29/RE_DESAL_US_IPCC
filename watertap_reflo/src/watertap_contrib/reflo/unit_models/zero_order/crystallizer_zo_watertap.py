...
from watertap_reflo.src.watertap_contrib.reflo.costing.units.crystallizer_watertap import (
...
class CrystallizationData(InitializationMixin, UnitModelBlockData):
    ...
    **Valid values:** {
    ...
    def calculate_scaling_factors(self):
        ...
        for ind, c in self.eq_vapor_energy_constraint.items():
            sf = iscale.get_scaling_factor(self.energy_flow_superheated_vapor)
            iscale.constraint_scaling_transform(c, sf)
