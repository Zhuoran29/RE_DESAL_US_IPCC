...
def FPC_MD_cryst_cal():
    ...
    csv_outfile6 = 'coastal_FPC_MD_2050_sm3.csv'
    ...
    for index, row in df.iterrows():
        try:      
            ...
            MDB_cap = desal_cap /  MDB_rr # m3/day
            cryst_cap = 0 # m3/day
            ...
            data_table =  0
            overall_performance = {"Initial thermal energy consumption (kW)": 0,
                                   "Total solids collected (kg/s)": 0}
