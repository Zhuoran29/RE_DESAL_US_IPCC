...
def wind(wind_resource, capacity):
	ssc = PySSC()
	ssc.module_exec_set_print(0)
	data = ssc.data_create()
	ssc.data_set_number( data, b'wind_resource_model_choice', 0 )
	# ssc.data_set_string( data, b'wind_resource_filename', b'/Users/zhuoranzhang/SAM Downloaded Weather Files/WIND-Toolkit_lat40.00_lon-116.00_2014_60min.csv' )
	...
	ssc.data_set_number( data, b'system_capacity', 30000 )
	wind_farm_xCoordinates =[ 0, 800, 1600, 2400, 0, 800, 1600, 2400, 0, 800, 1600, 2400 ]
	ssc.data_set_array( data, b'wind_farm_xCoordinates',  wind_farm_xCoordinates)
	wind_farm_yCoordinates =[ 0, 0, 0, 0, 800, 800, 800, 800, 1600, 1600, 1600, 1600 ]
	...
	ssc.data_set_array_from_csv( data, b'grid_curtailment', b'/Users/zhuoranzhang/Downloads/temp/grid_curtailment.csv')
	...
	ssc.data_set_number( data, b'capital_cost', 1115 * capacity  )
	ssc.data_set_number( data, b'fixed_operating_cost', 215 * capacity )
	ssc.data_set_number( data, b'variable_operating_cost', 0 )
	ssc.data_set_number( data, b'fixed_charge_rate', 1 )
...
if __name__ == "__main__":
	[energy, lcoe_fcr] = wind(wind_resource = '/Users/zhuoranzhang/Documents/Github_repos/Modeling_code/Wind_resource/output_(-112.074011 33.448443).csv',
			    capacity = 30000)
