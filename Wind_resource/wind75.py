...
def wind75(wind_resource):
	...
	ssc.data_set_number( data, b'system_capacity', 75000 )
	wind_farm_xCoordinates =[ 0, 800, 1600, 2400, 3200, 4000, 0, 800, 1600, 2400, 3200, 4000, 0, 800, 1600, 2400, 3200, 4000, 0, 800, 1600, 2400, 3200, 4000, 0, 800, 1600, 2400, 3200, 4000 ];
	ssc.data_set_array( data, b'wind_farm_xCoordinates',  wind_farm_xCoordinates);
	wind_farm_yCoordinates =[ 0, 0, 0, 0, 0, 0, 800, 800, 800, 800, 800, 800, 1600, 1600, 1600, 1600, 1600, 1600, 2400, 2400, 2400, 2400, 2400, 2400, 3200, 3200, 3200, 3200, 3200, 3200 ];
	...
	ssc.data_set_number( data, b'capital_cost', 83625000 / 1115 * 1261)
	ssc.data_set_number( data, b'fixed_operating_cost', 1875000 / 25 * 27 )
