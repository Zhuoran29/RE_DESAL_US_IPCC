...
def NF_LSRRO_cryst_cal():
    ...
    csv_outfile6 = 'elec_sensitivity_lowBatt.csv'
    ...
    for index, row in df.iterrows():
        try:      
            ...
            SEEC_lsrro = 0.2391 * NF_permeate_tds + 0.5653 # kWh/m3
    ...
    try:
        for i in range(len(solar_multiples)):
            ...
            for storage in storage_hours:
                ...
                print(sm, storage, round(LCOW,4), round(cost_elec,3))
                # Update value if a lower LCOW is achieved
                if LCOW < minLCOW * 1.03:
