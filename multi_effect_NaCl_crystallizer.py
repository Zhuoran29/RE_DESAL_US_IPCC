...
def add_heat_exchanger_eff1(m, steam_pressure):
    ...
    def heat_transfer_equation_eff_1(b, t):
        return b.fs.eff_1.work_mechanical[0] == pyunits.convert(
...
def multi_effect_crystallizer_initialization(m):
    ...
    print('dof of eff 1: ', degrees_of_freedom(m.fs.eff_1))
    print('dof of eff 2: ', degrees_of_freedom(m.fs.eff_2))
    print('dof of eff 3: ', degrees_of_freedom(m.fs.eff_3))
    print('dof of eff 4: ', degrees_of_freedom(m.fs.eff_4))
...
def get_model_performance(m):
    ...
    overall_performance = {
        ...
        "Total water prod vol (m3/s)": sum(water_prod) / 1000,
...
if __name__ == "__main__":
    ...
    print('LCOW:', value(m.fs.levelized_cost_of_feed_brine))